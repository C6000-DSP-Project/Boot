...
;***************************************************************
;
; __STACK_SIZE is defined by linker option
;
__stack:.usect    ".stack", 0, 4
__IRQ_STACK_SIZE: .set 0x1000
__FIQ_STACK_SIZE: .set 0x1000
__irq_stack:.usect ".irq_stack", __IRQ_STACK_SIZE, 4
__fiq_stack:.usect ".fiq_stack", __FIQ_STACK_SIZE, 4
...
_c_int00: .asmfunc
    ...
    .endif
        ...
        ;ORR     r0, r0, #0x1F   ; set to priviliage mode
        MSR     cpsr, r0
